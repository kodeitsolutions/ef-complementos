...
#Region "Eventos"
    ...
    Handles cmdAceptar.Click
        ...
        loConsulta.AppendLine("")
        loConsulta.AppendLine("IF RTRIM(@lcTipo) = 'Salida'")
        ...
        loConsulta.AppendLine("")
        loConsulta.AppendLine("	    DECLARE @lnCostoPro1 DECIMAL(28,10) = ((@lnCantidadFac * @lnPrecio1)  + (@lnExi_Art * @lnCosPro1_Art)) / (@lnCantidadFac + @lnExi_Art)")
