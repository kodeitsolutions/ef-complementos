<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_frmAsignarOrdenAdelanto.aspx.vb" Inherits="CGS_frmAsignarOrdenAdelanto" %>
...
<html>
<head runat="server">
    <title>Asignar orden de compra a adelanto</title>
                            ...
                            <tr>
                                <td colspan="4" style="width: 100%;" class="SeparadorSeccionesFormularios">
                                    <vis1Controles:lblNormal runat="server" ID="lblTitulo"
                                        CssClass="TituloPanel" Text="Asignar orden de compra a adelanto"></vis1Controles:lblNormal>
                                </td>
                            </tr>
                        </thead>
                            ...
                            <tr>
                                <td>
                                    <vis1Controles:lblNormal runat="server" ID="lblDocumento"
                                        CssClass="Etiqueta" Text="Orden de compra:"></vis1Controles:lblNormal>
                                </td>
