<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_frmFacturasProduccion.aspx.vb" Inherits="CGS_frmFacturasProduccion" %>
...
<html>
<head runat="server">
    <title>Asociar Recepción a renglón de Factura de Compra</title>
            ...
            <ContentTemplate>
                <div class="divCuerpoComplemento">
                            ...
                            <tr>
                                <td colspan="4" style="width: 100%;" class="SeparadorSeccionesFormularios">
                                    <vis1Controles:lblNormal runat="server" ID="lblTitulo"
                                        CssClass="TituloPanel" Text="Asociar Recepción a renglón de Factura de Compra"></vis1Controles:lblNormal>
                                </td>
                            </tr>
                        </thead>
                    ...
                    <div class="divContenedorGrid">
						...
						<vis3Controles:grdListaRenglones ID="grdRenglones" runat="server" pcTitulo="Renglones de recepción" plPermitirActualizarRenglones="False"
